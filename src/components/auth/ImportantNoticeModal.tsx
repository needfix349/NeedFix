  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-amber-100 text-[10px] font-normal truncate">
                {userName ? `Mandatory guidelines for ${userName}` : 'Mandatory guidelines for all customers & services'}
              </p>
            </div>
          </div>
          <button
        ...
        {/* Modal Body - Both English & Hindi for clear readability */}
        <div className="p-3.5 sm:p-4 space-y-3 max-h-[65vh] overflow-y-auto">
          {/* English Section */}
          <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3 space-y-1.5">
            ...
            <p className="text-slate-700 text-xs leading-relaxed font-normal">
              ...
              &ldquo;NeedFix is a platform designed solely to connect customers with local service providers. Please note that any work or service you engage in is entirely at your own discretion. Kindly ensure proper supervision and take personal responsibility for the safety, quality, and management of the work being done.&rdquo;
            </p>
          </div>
